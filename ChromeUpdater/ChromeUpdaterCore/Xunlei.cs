...
namespace ChromeUpdater.Core
{
    ...
    {
        // Methods
        [DllImport("xldl.dll", EntryPoint = "XL_QueryTaskInfoEx", CallingConvention = CallingConvention.StdCall)]
        public static extern IntPtr XL_CreateBTTask(DownBtTaskParam stParam);
        [DllImport("xldl.dll", CallingConvention = CallingConvention.StdCall)]
        ...
        public class DownTaskParam
        {
            ...
            public int IsOnlyOriginal;
            public uint nReserved1 = 5;
            public int DisableAutoRename;
