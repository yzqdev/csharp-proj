...
namespace DMSkin
{
    ...
    public partial class DMSkinSimpleWindow:Window
    {
        ...
        {
            ResourceDictionary dic = new ResourceDictionary { Source = new Uri(@"/DMSkin;component/Styles/DMSkinSimpleWindow.xaml", UriKind.Relative) };
            Resources.MergedDictionaries.Add(dic);
            Style = (Style)dic["MainWindow"];

            //string packUriAnimation = @"/DMSkin;component/Themes/Animation.xaml";
